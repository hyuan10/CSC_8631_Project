...
Graphs 3, 4 and 5 visualises the range of incorrect results and the frequency of which they occur. Assuming each individual attempts the multiple choice question until they get the correct answer, we are able to see, on average, the number of attampt the individuals take. With week 1 and 3, we see a positively skewed bell curve which indicates that a large proportion of the users are receiving getting the correct mark before the median of results. This could be a result of the 
