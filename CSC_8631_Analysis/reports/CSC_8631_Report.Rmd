...
The dplyr library allows for the user to use a set of verbs to write code for common data manipulation. It allows the user to use familiar words when scripting analysis and pre-processing scripts (such as filter) , both for easy understanding of the code and proof reading (Hadley Wickham, n.d.).
...
Hadley Wickham, R. F. (n.d.). dplyr. Retrieved from dplyr part of the tidyverse 1.0.7: https://dplyr.tidyverse.org/
