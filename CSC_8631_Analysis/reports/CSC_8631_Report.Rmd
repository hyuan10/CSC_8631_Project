...
ggplot is a system for creating graphics which is provided by the user which allows for said user to iteratively add new layers, components and functionality. 
